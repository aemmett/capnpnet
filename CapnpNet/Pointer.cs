...
namespace CapnpNet
{
  ...
  public struct Person : IStruct
  {
    private Struct _s;

    public Person(Struct s)
    {
      _s = s;
    }
    ...
    public PrimitiveList<byte> name // TODO: specialized type for text?
    {
    ...
    {
      get { return _s.DereferenceStruct<Date>(3); }
      set { _s.WritePointer(3, value); }
    }

    public PrimitiveList<byte> email
    {
      get { return _s.DereferenceList<byte>(1); }
      set { _s.WritePointer(1, value); }
    }

    public CompositeList<PhoneNumber> phones
    {
      get { return _s.DereferenceCompositeList<PhoneNumber>(2); }
      set { _s.WritePointer(2, value); }
    }

    public struct PhoneNumber : IStruct
    {
      private Struct _s;

      public PhoneNumber(Struct s)
      {
        _s = s;
      }
      ...
      public PrimitiveList<byte> number
      {
        get { return _s.DereferenceList<byte>(0); }
        set { _s.WritePointer(0, value); }
      }
      ...
      public Type type
      {
        get { return (Type)_s.ReadUInt16(0); }
  ...
  public struct Date : IStruct
  {
    private Struct _s;
    
    public Date(Struct s)
    {
      _s = s;
    }
    ...
    public short year
    {
      get { return _s.ReadInt16(0); }
      set { _s.WriteInt16(0, value); }
    }
